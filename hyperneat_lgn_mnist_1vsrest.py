...
def label_to_one_hot(label):
    one_hot = jnp.zeros(2, dtype=jnp.float32)
    index = 0 if label == single_class else 1
...
for img, label in test_set:
    ...
    if test_class_counts[label_idx] < num_test_per_class:
