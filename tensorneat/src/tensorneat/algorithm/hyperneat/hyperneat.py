...
from tensorneat.src.tensorneat.common import State, ACT, AGG
from tensorneat.src.tensorneat.algorithm import BaseAlgorithm, NEAT
from tensorneat.src.tensorneat.genome import BaseNode, BaseConn, RecurrentGenome
...
class HyperNEATNode(BaseNode):
    ...
    def forward(self, state, attrs, inputs, is_output_node=False):
        return jax.lax.cond(
            is_output_node,
            lambda: AGG.argmax_filtered(inputs),  # output node does not need activation
